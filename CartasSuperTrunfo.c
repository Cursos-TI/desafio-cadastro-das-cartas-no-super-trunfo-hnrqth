...
void entrada(char estado[20], char cod[20], char cidade[20], int *populacao, float *area, float *pib, int *pontosTuristicos) {
...
void saida(char estado[20], char cod[20], char cidade[20], int populacao, float area, float pib, int pontosTuristicos) {
...
int main() {
    // Carta 1
    char estado1[20], cod1[20], cidade1[20];
    int populacao1;
    float area1, pib1;
    int pontosTuristicos1;

    // Carta 2
    char estado2[20], cod2[20], cidade2[20];
    int populacao2;
    float area2, pib2;
